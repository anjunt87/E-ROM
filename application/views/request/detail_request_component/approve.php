 ...
 <?php if($this->session->userdata('role_id')=== '1'):?>
    <a class="btn btn-primary float-right ml-2" href="<?= site_url('request/historyRequestApp'); ?>">Kembali</a>   
    <!-- <a class="btn btn-info float-right " href="<?= site_url('request/Edit/'.$request['id_request']); ?>">Edit</a>  -->
...
<?php elseif($this->session->userdata('role_id')=== '6'):?>   
    <a class="btn btn-primary float-right ml-2" href="<?= site_url('request/usersRequestHistory'); ?>">Kembali</a>   
    <!-- <a class="btn btn-info float-right " href="<?= site_url('request/Edit/'.$request['id_request']); ?>">Edit</a>    -->
    <?php endif?>