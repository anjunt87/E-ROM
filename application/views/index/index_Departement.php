                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $this->db->select('*')->from('t_request')->like('departement_id', $data)->like('a_departement', '0' && '1' && '2');
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                               <?php
                                               $data = $record['departement_id'];
                                               $this->db->select('*')->from('t_request')->like('departement_id', $data)->like('a_departement', '2')->like('t_approve', '1');
                                               echo $this->db->count_all_results();
                                               ?>
                                            </div>
                                        </div>
