                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url('assets/'); ?>admin/https://source.unsplash.com/Mv9hjnEUHR4/60x60"
                                            alt="...">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div>
                        ...
                        <!-- Image Profile TopBar -->
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!-- <img class="img-profile rounded-circle" src="<?= base_url('assets/'); ?>img/profile/undraw_profile.svg"> -->
                                <?php if($record['img_profile'] == ''){ ?>
                                  <img src="<?php echo base_url().'/assets/img/profile/undraw_profile.svg'?>" class="img-profile rounded-circle">
                                <?php } else { ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= site_url('profile/indexProfile/'.$user['nik'])?>">
